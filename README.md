...
In order to determine protein degradation rates, we fit the experimental data of all the proteins and Lys using the matrix exponential function. The ODE for Lys and individual proteins (equation(11) and (9)) can be rewritten in matrix form  <img src="https://latex.codecogs.com/svg.latex?\Large&space;\frac{d}{dt}\mathbf{\theta}\left(t\right)=\mathbf{G\theta}(t)" title="S1" />
...
<a href="https://www.codecogs.com/eqnedit.php?latex={\mathbf{G}\left(\mathbf{\gamma}\right)}_{ij}=\left\{\begin{matrix}&space;{-\gamma}_i&space;&&space;if\&space;i=j\le&space;n\&space;\\&space;-\gamma_i&space;-\sum_{i=1}^{n}{\frac{\left[\eta_iP_i\right]}{\left[A\right]}}\gamma_i-\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}\gamma_U&space;&&space;if\&space;i=j=n&plus;1\\&space;\gamma_i&space;&&space;if\&space;i\le&space;n\&space;and\&space;j=n&plus;1\\&space;\frac{\left[\eta_j&space;P_j\right]}{\left[A\right]}\gamma_j&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j\le&space;n\\&space;\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}\gamma_U&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j=n&plus;3\\&space;\gamma_a&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j=n&plus;2\\&space;-\gamma_U&space;&&space;if\&space;i=j=n&plus;3\\&space;\gamma_U&space;&&space;if\&space;i=n&plus;3\&space;and\&space;j=n&plus;1\\&space;0&space;&&space;otherwise&space;\end{matrix}\right." target="_blank"><img src="https://latex.codecogs.com/gif.latex?{\mathbf{G}\left(\mathbf{\gamma}\right)}_{ij}=\left\{\begin{matrix}&space;{-\gamma}_i&space;&&space;if\&space;i=j\le&space;n\&space;\\&space;-\gamma_i&space;-\sum_{i=1}^{n}{\frac{\left[\eta_iP_i\right]}{\left[A\right]}}\gamma_i-\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}\gamma_U&space;&&space;if\&space;i=j=n&plus;1\\&space;\gamma_i&space;&&space;if\&space;i\le&space;n\&space;and\&space;j=n&plus;1\\&space;\frac{\left[\eta_j&space;P_j\right]}{\left[A\right]}\gamma_j&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j\le&space;n\\&space;\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}\gamma_U&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j=n&plus;3\\&space;\gamma_a&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j=n&plus;2\\&space;-\gamma_U&space;&&space;if\&space;i=j=n&plus;3\\&space;\gamma_U&space;&&space;if\&space;i=n&plus;3\&space;and\&space;j=n&plus;1\\&space;0&space;&&space;otherwise&space;\end{matrix}\right." /></a>

When the argument <a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{\gamma}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{\gamma}" /></a> is unambiguous, we simply write <a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{G}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{G}" /></a> instead of <a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{G}\left(\mathbf{\gamma}\right)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{G}\left(\mathbf{\gamma}\right)" /></a>.
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{\gamma}_\ast={\rm&space;argmin,\&space;}\below{\mathbf{\gamma}\in\mathbf{P}^{n&plus;2}}&space;\sum_{i=1}^{m}\left&space;\|&space;e^{t_i\mathbf{G}}\mathbf{\theta}\left(0\right)-\mathbf{\theta}\left(t_i\right)\right&space;\|_{W}^{2}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{\gamma}_\ast={\rm&space;argmin,\&space;}\below{\mathbf{\gamma}\in\mathbf{P}^{n&plus;2}}&space;\sum_{i=1}^{m}\left&space;\|&space;e^{t_i\mathbf{G}}\mathbf{\theta}\left(0\right)-\mathbf{\theta}\left(t_i\right)\right&space;\|_{W}^{2}" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{W}_{ij}=\left\{\begin{matrix}1&if\&space;i=j\le&space;n&plus;2\\0&otherwise\\\end{matrix}\right." target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{W}_{ij}=\left\{\begin{matrix}1&if\&space;i=j\le&space;n&plus;2\\0&otherwise\\\end{matrix}\right."  /></a>

exists solely to exclude the dimensions of <a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{\theta}\left(t\right)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{\theta}\left(t\right)" /></a> that are constructed from <a href="https://www.codecogs.com/eqnedit.php?latex=\theta_{A_F}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\theta_{A_F}" /></a> and <a href="https://www.codecogs.com/eqnedit.php?latex=\theta_U" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\theta_U"  /></a> from calculation of error.
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{\gamma}_0,u&space;:=&space;{\rm&space;argmin,\&space;}\below{\mathbf{\gamma}\in\mathbb{R}^{n&plus;2};u\in\mathbb{R}^k}=&space;\sum_{i=1}^{m}\left&space;\|&space;\mathbf{M}\left(\widehat{t_i}\right)\mathbf{\gamma}&space;-&space;\mathbf{\vartheta}\left(\widehat{t_i}\right)&space;&plus;u_i&space;\right&space;\|_{W}^{2}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{\gamma}_0,u&space;:=&space;{\rm&space;argmin,\&space;}\below{\mathbf{\gamma}\in\mathbb{R}^{n&plus;2};u\in\mathbb{R}^k}=&space;\sum_{i=1}^{m}\left&space;\|&space;\mathbf{M}\left(\widehat{t_i}\right)\mathbf{\gamma}&space;-&space;\mathbf{\vartheta}\left(\widehat{t_i}\right)&space;&plus;u_i&space;\right&space;\|_{W}^{2}"  /></a>

<a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{\gamma}_0,u&space;:=&space;{\rm&space;argmin,\&space;}\below{\mathbf{\gamma}\in\mathbb{R}^{n&plus;2};u\in\mathbb{R}^k}=" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{\gamma}_0,u&space;:=&space;{\rm&space;argmin,\&space;}\below{\mathbf{\gamma}\in\mathbb{R}^{n&plus;2};u\in\mathbb{R}^k}=" /></a> <img src="https://render.githubusercontent.com/render/math?math=\sum_{i=1}^{m}\left \| \mathbf{M}\left(\widehat{t_i}\right)\mathbf{\gamma} - \frac{d}{dt}\mathbf{\vartheta}\left(\widehat{t_i}\right) +u_i \frac{\left[A\right]}{\left[\eta_U\right]} \right \|_{W}^{2}">
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\theta_{U_L}:=&space;{\rm&space;argmax}\below{\psi\in\mathbit{S}}{\cos{\angle(}\mathbf{u},\&space;\psi)}=" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\theta_{U_L}:=&space;{\rm&space;argmax}\below{\psi\in\mathbit{S}}{\cos{\angle(}\mathbf{u},\&space;\psi)}=" /></a>

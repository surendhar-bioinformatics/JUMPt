...
<a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{\gamma}_0,u&space;:=&space;{\rm&space;argmin,\&space;}\below{\mathbf{\gamma}\in\mathbb{R}_+^{n&plus;2};u\in\mathbb{R}_+^k}=" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{\gamma}_0,u&space;:=&space;{\rm&space;argmin,\&space;}\below{\mathbf{\gamma}\in\mathbb{R}_+^{n&plus;2};u\in\mathbb{R}_+^k}=" /></a> <img src="https://render.githubusercontent.com/render/math?math=\sum_{i=1}^{m}\left \| \mathbf{M}\left(\widehat{t_i}\right)\mathbf{\gamma} - \frac{d}{dt}\mathbf{\vartheta}\left(\widehat{t_i}\right) {&plus;} u_i \frac{\left[A\right]}{\left[\eta_U\right]} \right \|_{W}^{2}">

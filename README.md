...
<a href="https://www.codecogs.com/eqnedit.php?latex={\mathbf{G}\left(\mathbf{\gamma}\right)}_{ij}=\left\{\begin{matrix}&space;\mathbf{-g}_i&space;&&space;if\&space;i=j\le&space;n\&space;\textup{or}&space;\&space;i=j=n&plus;3&space;\\&space;\mathbf{-g_i}&space;-\sum_{i=1}^{n}{\frac{\left[\eta_iP_i\right]}{\left[A\right]}}-\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}&space;&&space;if\&space;i=j=n&plus;1\\&space;\mathbf{g}_i&space;&&space;if\&space;(i\le&space;n\&space;and\&space;j=n&plus;1)&space;\&space;\textup{or}&space;\\&space;\&space;&&space;(i=n&plus;3\&space;\textup{and}\&space;j=n&plus;1)\\&space;\frac{\left[\eta_j&space;P_j\right]}{\left[A\right]}\mathbf{g}_i&space;&&space;if\&space;i=n&plus;1\&space;\textup{and}\&space;j\le&space;n\\&space;\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}&space;&&space;if\&space;i=n&plus;1\&space;\textup{and}\&space;j=n&plus;3\\&space;\mathbf{g}_i&space;&&space;if\&space;i=n&plus;1\&space;\textup{and}\&space;j=n&plus;2\\&space;0&space;&&space;\textup{otherwise}&space;\end{matrix}\right." target="_blank"><img src="https://latex.codecogs.com/gif.latex?{\mathbf{G}\left(\mathbf{\gamma}\right)}_{ij}=\left\{\begin{matrix}&space;\mathbf{-g}_i&space;&&space;if\&space;i=j\le&space;n\&space;\textup{or}&space;\&space;i=j=n&plus;3&space;\\&space;\mathbf{-g_i}&space;-\sum_{i=1}^{n}{\frac{\left[\eta_iP_i\right]}{\left[A\right]}}-\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}&space;&&space;if\&space;i=j=n&plus;1\\&space;\mathbf{g}_i&space;&&space;if\&space;(i\le&space;n\&space;and\&space;j=n&plus;1)&space;\&space;\textup{or}&space;\\&space;\&space;&&space;(i=n&plus;3\&space;\textup{and}\&space;j=n&plus;1)\\&space;\frac{\left[\eta_j&space;P_j\right]}{\left[A\right]}\mathbf{g}_i&space;&&space;if\&space;i=n&plus;1\&space;\textup{and}\&space;j\le&space;n\\&space;\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}&space;&&space;if\&space;i=n&plus;1\&space;\textup{and}\&space;j=n&plus;3\\&space;\mathbf{g}_i&space;&&space;if\&space;i=n&plus;1\&space;\textup{and}\&space;j=n&plus;2\\&space;0&space;&&space;\textup{otherwise}&space;\end{matrix}\right." /></a>

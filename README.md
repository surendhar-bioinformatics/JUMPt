...
<a href="https://www.codecogs.com/eqnedit.php?latex=\frac{{d\theta}_{P_i}}{dt}=\gamma_{i\theta_{A_L}}-\gamma_{i\theta_{P_i_L}}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{{d\theta}_{P_i}}{dt}=\gamma_{i\theta_{A_L}}-\gamma_{i\theta_{P_i_L}}"  /></a>

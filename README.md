...
<img src="https://render.githubusercontent.com/render/math?math=\theta_{U}:= {\rm argmin,\ }{\mathbf{\gamma}\in\mathbb{R}^{n+2}} \sum_{i=1}^{m}\left \| \mathbf{M}\left(\widehat{t_i}\right)\mathbf{\gamma} - \frac{d}{dt}\mathbf{\vartheta}\left(\widehat{t_i}\right) +u_i \frac{\left[A\right]}{\left[\eta_U\right]} \right \|_{W}^{2}">

...
<a href="https://www.codecogs.com/eqnedit.php?latex={\mathbf{G}\left(\mathbf{g}\right)}_{ij}=\left\{\begin{matrix}&space;{-\gamma}_i&space;&&space;if\&space;i=j\le&space;n\&space;\\&space;-\gamma_i&space;-\sum_{i=1}^{n}{\frac{\left[\eta_iP_i\right]}{\left[A\right]}}\gamma_i-\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}\gamma_U&space;&&space;if\&space;i=j=n&plus;1\\&space;\gamma_i&space;&&space;if\&space;i\le&space;n\&space;and\&space;j=n&plus;1\\&space;\frac{\left[\eta_j&space;P_j\right]}{\left[A\right]}\gamma_j&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j\le&space;n\\&space;\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}\gamma_U&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j=n&plus;3\\&space;\gamma_a&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j=n&plus;2\\&space;-\gamma_U&space;&&space;if\&space;i=j=n&plus;3\\&space;\gamma_U&space;&&space;if\&space;i=n&plus;3\&space;and\&space;j=n&plus;1\\&space;0&space;&&space;otherwise&space;\end{matrix}\right." target="_blank"><img src="https://latex.codecogs.com/gif.latex?{\mathbf{G}\left(\mathbf{g}\right)}_{ij}=\left\{\begin{matrix}&space;{-\gamma}_i&space;&&space;if\&space;i=j\le&space;n\&space;\\&space;-\gamma_i&space;-\sum_{i=1}^{n}{\frac{\left[\eta_iP_i\right]}{\left[A\right]}}\gamma_i-\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}\gamma_U&space;&&space;if\&space;i=j=n&plus;1\\&space;\gamma_i&space;&&space;if\&space;i\le&space;n\&space;and\&space;j=n&plus;1\\&space;\frac{\left[\eta_j&space;P_j\right]}{\left[A\right]}\gamma_j&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j\le&space;n\\&space;\frac{\left[\eta_U&space;P_U\right]}{\left[A\right]}\gamma_U&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j=n&plus;3\\&space;\gamma_a&space;&&space;if\&space;i=n&plus;1\&space;and\&space;j=n&plus;2\\&space;-\gamma_U&space;&&space;if\&space;i=j=n&plus;3\\&space;\gamma_U&space;&&space;if\&space;i=n&plus;3\&space;and\&space;j=n&plus;1\\&space;0&space;&&space;otherwise&space;\end{matrix}\right."  /></a>
